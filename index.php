			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-search">
						<form>
							<input class="input search-input" type="text" placeholder="Ingrese palabra clave">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						...
						<div class="banner-caption text-center">
							<h2 class="white-color">POR LLEGAR</h2>
						</div>
					</a>
				</div>
				<!-- /banner -->
				...
				<div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
					<a class="banner banner-1" href="#">
						...
						<div class="banner-caption text-center">
							<h2 class="white-color">TUTORIALES</h2>
						</div>
					</a>
				</div>
				<!-- /banner -->
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
		            ...
		            <img src="./img/logo.png" alt="">
						...
						<ul class="footer-social">
							<li><a href="#"><i class="fa fa-contact"></i> +52 55 5627 0210</a></li>
							<li><a href="https://api.whatsapp.com/send?phone=0123456789">Envíanos un mensaje de WhatsApp</a></li>
						</ul>
						<!-- /footer social -->
					</div>
				</div>

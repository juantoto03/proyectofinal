      ...
      <div class="pull-right">
        <ul class="header-btns">
          ...
          <li class="header-account dropdown default-dropdown">
            ...
            <a class="text-uppercase pointer" data-toggle="modal" data-target="#myModal">Login</a> / <a href="register.php" class="text-uppercase">Join</a>
            <!-- The Modal -->
				...
				<div class="category-nav">
					...
					<ul class="category-list">
						<li class="dropdown side-dropdown ">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Focos <i class="fa fa-angle-right"></i></a>
						...
						<li class="dropdown side-dropdown ">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Tubos de LED <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
						...
						<li class="dropdown side-dropdown ">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Luminario de LED <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu menu">
								<div class="row">
									<div class="col-md-8">
										<ul class="list-links">

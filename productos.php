                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <div class="product product-single">
                    <div class="product-thumb">
                      ...
                      <img src="<?php echo $pruducto["foto"];?>" height="300px">
                    </div>
                    <div class="product-body">
                      <h3 class="product-name"><?php echo $producto["nombre"];?></h3>
                      <h3 class="product-name"><?php echo $producto["modelo"];?></h3><br>
                      ...
                      <form class="" action="" method="post">
                        ...
                        <div class="product-btns">
                          <button class="primary-btn add-to-cart" name="btnAccion" type"submit" value="Agregar"><i class="fa fa-shopping-cart"></i> Agregar</button>
                        </div>
                      </form>
                    </div>
                  </div>
